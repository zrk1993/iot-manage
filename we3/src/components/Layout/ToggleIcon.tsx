...
const ToggleIcon: FC<{ onClick: () => void; collapsed: boolean }> = props => {
  return (
    <div className={`collapsed-button ${props.collapsed ? '-rotate-90' : 'rotate-90'}`}>
      <svg onClick={props.onClick} width='1em' height='1em' viewBox='0 0 12 12' fill='currentColor' aria-hidden='true'>
